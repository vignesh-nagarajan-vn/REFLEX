...
class RewardBreakdown:
    ...
    objective: Tensor  # spread_capture + inventory_pnl - adverse - inv_risk, scaled
...
def reward_from_components(
    ...
    objective = cfg.pnl_scale * (sc + ip - adv - inv_risk)
...
def reward(
    ...
    return reward_from_components(comps, transition.next_state.inventory, cfg, reduce=reduce)
