...
A market simulation model where trader strategies (parameterized by adversarialness a) determine stability: below α=1 the system converges to equilibrium, above it diverges into chaos. 
