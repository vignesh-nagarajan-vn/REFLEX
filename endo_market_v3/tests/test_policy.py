...
from reflex.objective import reward, reward_from_components
from reflex.policy import LinearPolicy, MLPPolicy, build_policy
...
def test_reward_components_and_markings() -> None:
    ...
    # including the quoting-cost anchor when the half-spread is supplied.
    rb_prim = reward_from_components(
        tr.pnl_components, tr.next_state.inventory, cfg.reward,
        half_spread=tr.quotes.half_spread,
    )
